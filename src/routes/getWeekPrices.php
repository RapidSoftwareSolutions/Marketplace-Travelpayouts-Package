...
$app->post('/api/Travelpayouts/getWeekPrices', function ($request, $response) {
    ...
    $optionalParams = ['currency'=>'currency','origin'=>'origin','destination'=>'destination','showToAffiliates'=>'show_to_affiliates','departDate'=>'depart_date','returnDate'=>'return_date'];
    $bodyParams = ['currency','origin','destination','show_to_affiliates','depart_date','return_date','token'];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);
    $requestBody = \Models\Params::createRequestBody($data, $bodyParams);

    $client = $this->httpClient;
    $query_str = "http://api.travelpayouts.com/v2/prices/week-matrix";
